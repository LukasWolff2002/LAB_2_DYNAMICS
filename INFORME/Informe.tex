...
In this laboratory experiment, we aim to analyze the dynamic response of MDOF systems under different conditions. The objectives include identifying the natural frequencies and modal shapes of an MDOF system, studying its response under free and forced vibrations, and experimentally determining the natural periods and mode shapes of a 3-DOF structure. Additional analysis includes examining the system’s behavior under harmonic excitation, particularly near resonance conditions, and evaluating the effects of damping on the vibration response. Finally, we will compare the seismic response obtained through an analytical model with that observed experimentally, to assess the consistency and limitations of both approaches.
